...
public partial class FE_IVADOC : Base 
{
	private string _FETICod = null!;
	public required string FETICod { get => _FETICod; set { if (_FETICod != value) { _FETICod = value; NotifyPropertyChanged();} } }
	private string _FETIDes = null!;
	public required string FETIDes { get => _FETIDes; set { if (_FETIDes != value) { _FETIDes = value; NotifyPropertyChanged();} } }
	private byte[]? _rv;
