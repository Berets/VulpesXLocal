...
public partial class cr_tab_ratings : Base 
{
	...
	private int? _from_point;
	public int? from_point { get => _from_point; set { if (_from_point != value) { _from_point = value; NotifyPropertyChanged();} } }
	private int? _to_point;
	public int? to_point { get => _to_point; set { if (_to_point != value) { _to_point = value; NotifyPropertyChanged();} } }
	private string? _sign;
	public string? sign { get => _sign; set { if (_sign != value) { _sign = value; NotifyPropertyChanged();} } }
	private string? _color;
	public string? color { get => _color; set { if (_color != value) { _color = value; NotifyPropertyChanged();} } }
