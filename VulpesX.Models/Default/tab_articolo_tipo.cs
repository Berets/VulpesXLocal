...
public partial class tab_articolo_tipo : Base 
{
	...
	private bool? _EMateriaPrima;
	public bool? EMateriaPrima { get => _EMateriaPrima; set { if (_EMateriaPrima != value) { _EMateriaPrima = value; NotifyPropertyChanged();} } }
	private byte[]? _rv;
	public byte[]? rv { get => _rv; set { if (_rv != value) { _rv = value; NotifyPropertyChanged();} } }
	private string? _DefaultMagazzinoID;
	public string? DefaultMagazzinoID { get => _DefaultMagazzinoID; set { if (_DefaultMagazzinoID != value) { _DefaultMagazzinoID = value; NotifyPropertyChanged();} } }
}