...
public partial class tab_produzione_operatore_risorsa : Base 
{
	...
	private string _OperatoreID = null!;
	public required string OperatoreID { get => _OperatoreID; set { if (_OperatoreID != value) { _OperatoreID = value; NotifyPropertyChanged();} } }
