...
public partial class FE_RFIDOC : Base 
{
	private string _regicod = null!;
	public required string regicod { get => _regicod; set { if (_regicod != value) { _regicod = value; NotifyPropertyChanged();} } }
	private string? _regides;
	public string? regides { get => _regides; set { if (_regides != value) { _regides = value; NotifyPropertyChanged();} } }
