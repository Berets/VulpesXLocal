...
public partial class log_crm_send : Base 
{
	...
	private int _document_number;
	public int document_number { get => _document_number; set { if (_document_number != value) { _document_number = value; NotifyPropertyChanged();} } }
