...
public partial class SRM_LISFOR : Base 
{
	private long _id;
	public long id { get => _id; set { if (_id != value) { _id = value; NotifyPropertyChanged();} } }
	private int _supplierID;
	public int supplierID { get => _supplierID; set { if (_supplierID != value) { _supplierID = value; NotifyPropertyChanged();} } }
	...
	public string? supplierProductID { get => _supplierProductID; set { if (_supplierProductID != value) { _supplierProductID = value; NotifyPropertyChanged();} } }
	private string? _supplierProductDescription;
	public string? supplierProductDescription { get => _supplierProductDescription; set { if (_supplierProductDescription != value) { _supplierProductDescription = value; NotifyPropertyChanged();} } }
