...
public partial class ACC_EINVOICE_ROWS_PIDS : Base 
{
	...
	private int _artprog;
	public int artprog { get => _artprog; set { if (_artprog != value) { _artprog = value; NotifyPropertyChanged();} } }
	private string? _artvalcod;
	public string? artvalcod { get => _artvalcod; set { if (_artvalcod != value) { _artvalcod = value; NotifyPropertyChanged();} } }
	private string? _artipcod;
	public string? artipcod { get => _artipcod; set { if (_artipcod != value) { _artipcod = value; NotifyPropertyChanged();} } }
	private byte[]? _rv;
