...
public partial class tab_produzione_operatore : Base 
{
	...
	public string? Badge { get => _Badge; set { if (_Badge != value) { _Badge = value; NotifyPropertyChanged();} } }
	private string? _UtenteID;
	public string? UtenteID { get => _UtenteID; set { if (_UtenteID != value) { _UtenteID = value; NotifyPropertyChanged();} } }
	private byte[]? _rv;
