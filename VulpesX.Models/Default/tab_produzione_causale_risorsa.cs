...
public partial class tab_produzione_causale_risorsa : Base 
{
	...
	private string _CausaleID = null!;
	public required string CausaleID { get => _CausaleID; set { if (_CausaleID != value) { _CausaleID = value; NotifyPropertyChanged();} } }
