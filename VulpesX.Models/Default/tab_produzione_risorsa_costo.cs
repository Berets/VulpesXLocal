...
public partial class tab_produzione_risorsa_costo : Base 
{
	...
	public DateTime Periodo { get => _Periodo; set { if (_Periodo != value) { _Periodo = value; NotifyPropertyChanged();} } }
	...
	public decimal? CostoOrario { get => _CostoOrario; set { if (_CostoOrario != value) { _CostoOrario = value; NotifyPropertyChanged();} } }
	private byte[]? _rv;
