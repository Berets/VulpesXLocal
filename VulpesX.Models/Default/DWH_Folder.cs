...
public partial class DWH_Folder : Base 
{
	...
	private Guid? _FolderID_Father;
	public Guid? FolderID_Father { get => _FolderID_Father; set { if (_FolderID_Father != value) { _FolderID_Father = value; NotifyPropertyChanged();} } }
