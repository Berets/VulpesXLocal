...
public partial class tab_produzione_reparto_risorsa : Base 
{
	...
	private string _RepartoID = null!;
	public required string RepartoID { get => _RepartoID; set { if (_RepartoID != value) { _RepartoID = value; NotifyPropertyChanged();} } }
