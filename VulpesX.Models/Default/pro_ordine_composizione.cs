...
public partial class pro_ordine_composizione : Base 
{
	...
	public string? ComponenteID { get => _ComponenteID; set { if (_ComponenteID != value) { _ComponenteID = value; NotifyPropertyChanged();} } }
	...
	public DateTime? Inizio { get => _Inizio; set { if (_Inizio != value) { _Inizio = value; NotifyPropertyChanged();} } }
	private DateTime? _Fine;
	public DateTime? Fine { get => _Fine; set { if (_Fine != value) { _Fine = value; NotifyPropertyChanged();} } }
	...
	public string? UniqueID { get => _UniqueID; set { if (_UniqueID != value) { _UniqueID = value; NotifyPropertyChanged();} } }
	private bool? _EFisso;
	public bool? EFisso { get => _EFisso; set { if (_EFisso != value) { _EFisso = value; NotifyPropertyChanged();} } }
	private long? _TempoAlPezzo;
	public long? TempoAlPezzo { get => _TempoAlPezzo; set { if (_TempoAlPezzo != value) { _TempoAlPezzo = value; NotifyPropertyChanged();} } }
	...
	private Guid? _UID;
	public Guid? UID { get => _UID; set { if (_UID != value) { _UID = value; NotifyPropertyChanged();} } }
	private byte[]? _rv;
	public byte[]? rv { get => _rv; set { if (_rv != value) { _rv = value; NotifyPropertyChanged();} } }
	private decimal? _QuantitaOriginale;
	public decimal? QuantitaOriginale { get => _QuantitaOriginale; set { if (_QuantitaOriginale != value) { _QuantitaOriginale = value; NotifyPropertyChanged();} } }
}