...
{
    public partial class FE_TIPORIT
    {
        public string FullDescriptionSearchable => $"{id} {description?.Trim()}";
        public string FullDescriptionNotSearchable => $"[{id}] {description?.Trim()}";
